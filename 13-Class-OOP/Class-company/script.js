class Developer {
  ...
  learnNewTechnologies(technology) {
    ...
    else this.technologies.push(technology);
  }
}
...
class JuniorDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies(['HTML', 'CSS', 'JavaScript']);
  }
...
class MiddleDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies(['HTML', 'CSS', 'JavaScript', 'React']);
  }
...
class SeniorDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies(['HTML', 'CSS', 'JavaScript', 'React', 'NodeJS']);
  }
